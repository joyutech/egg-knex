...
class BaseSqlDao {
   ...
   * @param {*} where 
   * @param {*} fields 
   * @param {Object} options 暂时只支持 limit、offset 字段
   * @returns 
   */
  ...
  async insert(examples) {
    return await this.baseInsert(this.app.knex, examples);
  }

  async del(where) {
    return await this.baseDel(this.app.knex, where);
  }

  async update(example, where) {
    return await this.baseUpdate(this.app.knex, example, where);
  }

  async updateAndFind(example, where) {
    await this.baseUpdate(this.app.knex, example, where);
    return await this.baseSelect(this.app.knex, where);
  }

  async select(where, fields, options) {
    return await this.baseSelect(this.app.knex, where, fields, options);
  }

  async count(where) {
    return await this.baseCount(this.app.knex, where);
  }

  async upsert(examples, pk){
    return await this.baseUpsert(this.app.knex, examples, pk);
  }
}
